            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" @click.prevent>{{$t('edit_list')}}
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="dashboard_container">
                    <div class="row">
                        <div class="col-12 pt-3">
                            <h2 class="font-weight-bold fun_font text-center">{{$t('edit_list')}}</h2>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           v-validate="'required'" data-vv-name="price" v-model="dataModel.price"
                                           class="form-control"
                                           :placeholder="$t('price')">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           v-validate="'required'" data-vv-name="price_before_discount"
                                           v-model="dataModel.price_before_discount"
                                           class="form-control"
                                           :placeholder="$t('price_before_discount')">
                                    <span class="text-danger text-sm">{{ errors.first('price_before_discount') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group direction">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" v-model="dataModel.type" style="height: 54px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="video/*" @change="previewVideo()" ref="myVideo"
                                           data-vv-name="video"
                                           class="form-control"
                                           :placeholder="$t('video')">
                                    <span class="text-danger text-sm">{{ errors.first('video') }}</span>
                                </div>
                                <a v-if="videoID" @click="openEmbeded(videoID)" target="_blank"
                                   class="font-weight-bold">
...
<script>
    ...
    export default {
        name: "Edit",
        components: {SweetModal, vueVimeoPlayer, VueCropper},
        data() {
            return {
                dataModel: {
                    title_ar: '',
        ...
        methods: {
            ...
            findList() {
                ...
                dispatch.then((response) => {
                    ...
                    vm.videoID = list.video;
                    delete list.video;
                    vm.$helper.replaceNullWithSingleQuote(list)
                    vm.dataModel = list;
            ...
            editList() {
                ...
                vm.$store.dispatch('moduleList/updateList', payload)
                    .then(() => {
                        vm.$helper.hideLoader()
                        vm.$helper.showMessage('success', vm);
                        vm.$router.push({name: 'all_lists'});
                        $('#loader_message').text('')
                    })
                    .catch(error => {
                        vm.$helper.handleError(error, vm);
