            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" @click.prevent>{{$t('edit_question')}}
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="dashboard_container">
                    <div class="row">
                        <div class="col-12 pt-3">
                            <h2 class="font-weight-bold fun_font text-center">{{$t('edit_question')}}</h2>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            findQuestion() {
                ...
                let dispatch = this.$store.dispatch('moduleQuestion/findQuestion', {
                    id: vm.$route.params.id
                });
                dispatch.then((response) => {
                    vm.dataModel = response.data.data.question;
            ...
            updateQuestion() {
                ...
                vm.$store.dispatch('moduleQuestion/updateQuestion', payload)
                    .then(() => {
                        vm.$helper.hideLoader()
