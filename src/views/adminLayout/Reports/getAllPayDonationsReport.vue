                ...
                <div class="dashboard_container">
                    <div class="row">
                        <div class="col-12 pt-3">
                            <h2 class="font-weight-bold fun_font text-center">{{$t('getAllPayDonationsReport')}}</h2>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left">{{$t('paid_price')}}</th>
                                    <th class="text-left">{{$t('phone')}}</th>
                                    <th class="text-left">{{$t('paid_date')}}</th>
                                </tr>
                                </thead>
                                <tbody>
    ...
    export default {
        ...
        methods: {
            ...
            getAllUsers() {
                ...
                console.log(filters)
                let dispatch = this.$store.dispatch('moduleReport/donationsReport', filters);
                dispatch.then((response) => {
                    vm.users = response.data.data.supports.data;
                    vm.last_page = response.data.data.supports.last_page;
