            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" @click.prevent>{{$t('edit_testimonial')}}
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="dashboard_container">
                    <div class="row">
                        <div class="col-12 pt-3">
                            <h2 class="font-weight-bold fun_font text-center">{{$t('edit_testimonial')}}</h2>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.findTestimonial();
        },
        methods: {
            findTestimonial() {
                let vm = this;
                vm.$helper.showLoader();
                let dispatch = this.$store.dispatch('moduleTestimonial/findTestimonial', {
                    id: vm.$route.params.id
                });
                dispatch.then((response) => {
                    let testimonial = response.data.data.testimonials;
                    vm.$helper.replaceNullWithSingleQuote(testimonial)
                    vm.dataModel = testimonial;
            ...
            editTestimonial() {
                ...
                vm.$store.dispatch('moduleTestimonial/updateTestimonial', payload)
                    .then(() => {
                        vm.$helper.hideLoader();
