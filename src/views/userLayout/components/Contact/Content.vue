                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="p-4">
                                <ul class="text-black mb-5" v-if="$i18n.locale == 'en'">
                                    <li>
                                ...
                                <ul class="text-black direction mb-5" v-if="$i18n.locale == 'ar'">
                                    <li>
                                        <i class="ti-map-alt fa-lg pr-4"></i>
                                        <b class="font-weight-bold">{{$t('address')}}</b>
                                    </li>
