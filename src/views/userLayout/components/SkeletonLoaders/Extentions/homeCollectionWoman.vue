<template>
    <div class="p-5 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-right direction">
                    <div class="post ">
                        <div class="line w-50"></div>
                    </div>
                </div>
            </div>
            <div class="row direction-inverse">
                <div class="col-md-4">
                    <div class="header_skeleton" style="height: 500px;">
                        <div class="header_avatar" style="height: 500px;"></div>
                    </div>
                </div>
                <div class="col-md-8">
...
<style scoped>
    ...
    .header_skeleton .header_avatar {
        width: 100%;
        height: 250px;
        background-image: linear-gradient(90deg, #F4F4F4 0px, rgba(229, 229, 229, 0.8) 40px, #F4F4F4 80px);
        background-size: contain;
        animation: shine-avatar 4s infinite ease-out;
    }
